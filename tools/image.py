...
import requests
from setup_environment import config
from langchain.tools import tool
from openai import OpenAI
from pydantic import BaseModel, Field

IMAGE_DIRECTORY = Path(__file__).parent.parent / "images"
CLIENT = OpenAI(api_key=str(config["LLM"]["OPENAI_API_KEY"]))
...
if __name__ == "__main__":
    print(generate_image.run("A picture of a friendly monster in a New York skycrapper"))
